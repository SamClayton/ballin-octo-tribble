/*  OctoWS2811 Ac Crystal Flickering
...
void AcCrystalFlicker(int crystal) {
  int chosenPixels[AcLedsPerCrystal];
  for (int i=0+(AcLedsPerCrystal*crystal); int < (AcLedsPerCrystal*(crystal+1)); i++) {
